...
public class RequestHandler {
    ...
    public Optional<? extends MediaEntity> searchByID(String SearchInput){
        ...
        if(SearchInput.startsWith("audio_")) return music.getById(Long.parseLong(SearchInput.replaceFirst("audio_", "")));
        else  return video.getById(Long.parseLong(SearchInput.replaceFirst("video_", "")));
    }
